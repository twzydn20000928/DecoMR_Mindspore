...
LSP_ROOT = '/root/DecoMR/lsp/lsp_dataset'
LSP_ORIGINAL_ROOT = '/root/DecoMR/lsp/lsp_dataset_original'
UPI_S1H_ROOT = '/root/DecoMR/mydata/up-3d/upi-s1h'
MPII_ROOT = ''
COCO_ROOT = ''
UP_3D_ROOT = 'datasets/up-3d'
UP_3D_little_ROOT = '/root/DecoMR/mydata/up-3d/up-3d-little'
SURREAL_ROOT = ''
PW3D_ROOT = ''
MPI_INF_3DHP_ROOT = ''
LSPET_ROOT = ''
...
DATASET_NPZ_PATH = 'datasets/models'
...
CUBE_PARTS_FILE = 'models/data/cube_parts.npy'
JOINT_REGRESSOR_TRAIN_EXTRA = 'models/data/J_regressor_extra.npy'
VERTEX_TEXTURE_FILE = 'models/data/vertex_texture.npy'
SMPL_FILE = 'models/data/basicModel_neutral_lbs_10_207_0_v1.0.0.pkl'
MALE_SMPL_FILE = 'models/data/basicmodel_m_lbs_10_207_0_v1.0.0.pkl'
FEMALE_SMPL_FILE = 'models/data/basicModel_f_lbs_10_207_0_v1.0.0.pkl'

JOINT_REGRESSOR_H36M = 'models/data/J_regressor_h36m.npy'
LSP_REGRESSOR_EVAL = 'models/data/smpl2lsp_j_regressor_nt_v2.npy'
