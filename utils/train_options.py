...
class TrainOptions(object):
    ...
    def __init__(self):
        ...
        # io.add_argument('--pretrained_checkpoint', default='/data/users/user1/Master_04/DecoMR_Mindspore/logs/sample_dp/checkpoints/final.pt', help='Load a pretrained network when starting training')
        io.add_argument('--pretrained_checkpoint',
                        default='logs/sample_dp/checkpoints/final.pt',
        ...
        train.add_argument('--num_epochs', type=int, default=180, help='Total number of training epochs')
