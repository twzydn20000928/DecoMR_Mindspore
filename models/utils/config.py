...
LSP_ROOT = '/root/Deco_MR/lsp/lsp_dataset'
LSP_ORIGINAL_ROOT = '/root/Deco_MR/lsp/lsp_dataset_original'
UPI_S1H_ROOT = '/root/Deco_MR/mydata/up-3d/upi-s1h'
MPII_ROOT = ''
COCO_ROOT = ''
UP_3D_ROOT = '/root/Deco_MR/mydata/up-3d/up-3d'
UP_3D_little_ROOT = '/root/Deco_MR/mydata/up-3d/up-3d-little'
SURREAL_ROOT = ''
PW3D_ROOT = ''
MPI_INF_3DHP_ROOT = ''
LSPET_ROOT = ''
...
DATASET_NPZ_PATH = '/root/Deco_MR_mindspore/DATASET_NPZ_PATH'
...
DATASET_FILES = [ {'h36m-p1': join(DATASET_NPZ_PATH, 'h36m_valid_protocol1.npz'),
                  ...
                  {'h36m-train': join(DATASET_NPZ_PATH, 'h36m_train_new.npz'),
                   ...
                   'up-3d-little': join(DATASET_NPZ_PATH, 'up_3d_trainval_little.npz'),
...
DATASET_FOLDERS = {'h36m-train': H36M_ROOT,
                   ...
                   'up-3d': UP_3D_ROOT,
                    'up-3d-little': UP_3D_little_ROOT,
...
CUBE_PARTS_FILE = '/root/Deco_MR/data/cube_parts.npy'
JOINT_REGRESSOR_TRAIN_EXTRA = '/root/Deco_MR/data/J_regressor_extra.npy'
VERTEX_TEXTURE_FILE = '/root/Deco_MR/data/vertex_texture.npy'
SMPL_FILE = '/root/Deco_MR/data/basicModel_neutral_lbs_10_207_0_v1.0.0.pkl'
MALE_SMPL_FILE = '/root/Deco_MR/data/basicmodel_m_lbs_10_207_0_v1.1.0.pkl'
FEMALE_SMPL_FILE = '/root/Deco_MR/data/basicmodel_f_lbs_10_207_0_v1.1.0.pkl'

JOINT_REGRESSOR_H36M = '/root/Deco_MR/data/J_regressor_h36m.npy'
LSP_REGRESSOR_EVAL = '/root/Deco_MR/data/smpl2lsp_j_regressor_nt_v2.npy'
